...
const MyFooter = () => {
  return (
    <Container className="container pt-lg-4">
      <Row className=" mx-4">
        <Col>
      ...
      <Row className="info d-flex justify-content-center mb-3 mx-4">
      ...
      <Row className="end-page">
        <Col>
          <Button
            className="mx-4 py-1 text-white-50 border border-secondary mb-3"
            style={{ backgroundColor: "#141414", fontSize: "0.8rem" }}
          >
            Service Code
          </Button>
          <h6 className="text-white-50 fw-normal mx-4" style={{ fontSize: "0.6rem" }}>
